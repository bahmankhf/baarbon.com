 ...
 *   https://datatables.net/download/#dt/dt-1.10.12/af-2.1.2/b-1.2.2/b-colvis-1.2.2
 *
 * Included libraries:
 *   DataTables 1.10.12, AutoFill 2.1.2, Buttons 1.2.2, Column visibility 1.2.2
 */
...
(function(h) {
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            f = a.aanFeatures,
            g = d.sSearch,
            j = '<input type="search" class="' + b.sFilterInput + '"/>',
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo:"نمایش_START_ تا _END_ از _TOTAL_ مورد موجود",
            sInfoEmpty: "هیچ آگهی‌ای برای نمایش وجود ندارد",
            sInfoFiltered: "",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: '<span class="label">تعداد موارد در هر صفحه:</span> _MENU_ ',
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: '<span class="label">جستجو در لیست:</span>',
            sSearchPlaceholder: "",
            sUrl: "",
    ...
    m.ext = v = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.10.12/af-2.1.2/b-1.2.2/b-colvis-1.2.2",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
    ...
    e.extend(m.prototype, {
        ...
        _focusListener: function() {
            var b = this,
                c = this.s.dt,
                a = this.s.namespace,
                d = null !== this.c.focus ? this.c.focus : c.settings()[0].keytable ? "focus" : "hover";
            ...
            if (!1 !== b) {
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var e = 0, f = c.length; e < f; e++)
                        for (var g = 0, i = c[e].length; g < i; g++) d = c[e][g], d.cell.data(d.set);
                    a.draw(!1)
                }
    ...
    m.actions = {
        increment: {
            ...
            execute: function(b, c, a) {
                for (var b = 1 * c[0][0].data, a = 1 * e("input", a).val(), d = 0, h = c.length; d < h; d++)
                    for (var f = 0, g = c[d].length; f < g; f++) c[d][f].set = b, b += a
            }
        },
        fill: {
            available: function() {
        ...
        fillHorizontal: {
            ...
            execute: function(b, c) {
                for (var a = 0, d = c.length; a < d; a++)
                    for (var e = 0, f = c[a].length; e < f; e++) c[a][e].set = c[a][0].data
            }
        },
        fillVertical: {
            available: function(b, c) {
            ...
            execute: function(b, c) {
                for (var a = 0, d = c.length; a < d; a++)
                    for (var e = 0, f = c[a].length; e < f; e++) c[a][e].set = c[0][e].data
            }
        },
        cancel: {
            available: function() {
